...
SINGLE_CITY_HOURLY_COMPAT_FIELDS = (
    "temperature_2m,relative_humidity_2m,wind_speed_10m,wind_direction_10m,precipitation_probability,weather_code"
)
...
def _prune_public_weather_cache(now: datetime | None = None):
    ...
    expired_keys = [cache_key for cache_key, (expires_at, _) in _public_weather_cache.items() if expires_at <= now]
    ...
    return {
        ...
        "hourly": {
            ...
            "precipitation_probability": [
                entry["precipitation_probability"] for entry in hourly_items[:PUBLIC_HOURLY_FORECAST_HOURS]
            ],
